---
title: "Creating your own Large Language Model on EKS"
sidebar_position: 30
chapter: true
...
$ prepare-environment aiml/makemore
```
...
1. Create a Karpenter NodePool to provision Inferentia and Tranium EC2 instances
2. Compile a ResNet-50 pre-trained model for use with AWS Inferentia using a Tranium instance
